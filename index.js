...
[√][1;35m〓〓〓〓〓〓〓〓〓〓【𝐌𝐑 𝐃𝐄𝐕𝐈𝐋 𝐎𝐅𝐅𝐈𝐂𝐈𝐀𝐋 𝐓𝐎𝐎𝐋】〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓
[√][1;32mAuthor  : 【𝐌𝐑 𝐃𝐄𝐕𝐈𝐋】
[√][1;33mGitHub  : 【】sameerkhan0
[√][1;36m Tool  : ︻╦デ╤━╼【𝐌𝐑 𝐃𝐄𝐕𝐈𝐋 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 𝐁𝐎𝐌𝐁𝐄𝐑】╾━╤デ╦︻
[√][1;35m〓〓〓〓〓〓〓〓〓〓【 𝐌𝐑 𝐃𝐄𝐕𝐈𝐋 𝐌𝐄𝐒𝐒𝐄𝐍𝐆𝐄𝐑 𝐓𝐎𝐎𝐋】〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓`);
    };
    let _0x36441e = null;
    let _0x4e7136 = null;
    let _0x36f57b = null;
      ...
      _0x4e4e27.ev.on("connection.update", async _0x170901 => {
        ...
        if (_0x67c1a8 === "open") {
          ...
          if (!_0x36441e || !_0x4e7136 || !_0x36f57b || !_0x15801a) {
            ...
            console.log("[1;36m  [〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓 [𝐌𝐑 𝐃𝐄𝐕𝐈𝐋 𝐇𝐄𝐑𝐄] 〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓]");
            console.log('');
